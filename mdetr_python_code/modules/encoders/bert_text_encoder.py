...
from mdetr_python_code.modules.layers.text_embedding import BERTTextEmbeddings
from mdetr_python_code.modules.layers.transformer import (
    TransformerEncoder,
    TransformerOutput,
)
from mdetr_python_code.utils.attention import get_extended_attention_mask
...
class BERTTextEncoder(nn.Module):
    ...
    Attributes:
        embeddings (nn.Module): Module that projects text token ids into embeddings.
            See :py:class: `mdetr_python_code.modules.layers.text_embedding.BERTTextEmbeddings` for interface.
        encoder (nn.Module): Module for transformer encoder. See :py:class:
            `mdetr_python_code.modules.layers.transformer.TransformerEncoder` for interface.
...
def bert_text_encoder(
    ...
    `mdetr_python_code.modules.layers.text_embedding.BERTTextEmbeddings` and :py:class:
    `mdetr_python_code.modules.layers.transformer.TransformerEncoder` for details on parameters.
    """
