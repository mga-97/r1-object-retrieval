...
from mdetr_python_code.utils.attention import get_causal_attention_mask


class SampleOutput(NamedTuple):
    """Outputs from :meth:`~code.utils.generate.GenerationUtil.sample`.
...
class GenerationUtil:
    ...
    def sample(
        ...
        **model_kwargs: Any,
        ...
        Returns:
            An instance of :class:`~code.utils.generate.SampleOutput`.
        """
